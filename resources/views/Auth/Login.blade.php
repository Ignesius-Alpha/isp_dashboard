                ...
                <form action="" method="post">
                    ...
                    <div class="xl:mx-28 2xl:mx-36 flex flex-col space-y-4">
                        ...
                        <label class="flex gap-x-2 text-[#173D6B] items-center justify-start">
                            ...
                            class="form-check border-gray-400 bg-transparent text-[#173D6B] placeholder:text-[#173D6B] placeholder:text-opacity-50 border size-5 bg-amber-300"> Remember me</label>
